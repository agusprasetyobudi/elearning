            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="text-right">
                    <a href="{{ route('VideoCourseCreateAdmin') }}" class="btn btn-default">Create Course</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                                ...
                                @foreach ($course as $item)
                                    <tr>
                                        ...
                                        <td colspan="2" class="text-center">
                                            <a href="{!! route('VideoCourseUpdateAdminView',['id'=>$item->id]) !!}" class="btn btn-warning">Update</a>
                                            <a href="{!! route('VideoCourseDeletedAdmin',['id'=>$item->id]) !!}" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
